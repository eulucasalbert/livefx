        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-5 neon-glow-purple">
          ...
          {inWebView && (
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 text-sm text-yellow-200 space-y-2">
              <p className="font-bold">⚠️ Navegador não suportado para login com Google</p>
              <p>Abra este link no seu navegador (Chrome, Safari, etc.) para usar o login com Google. Toque nos 3 pontos (⋮) e selecione <strong>"Abrir no navegador"</strong>.</p>
              <Button
                type="button"
                variant="outline"
                size="sm"
                ...
                onClick={() => {
                  ...
                  toast({ title: "Link copiado!", description: "Cole no seu navegador." });
                }}
              >
                📋 Copiar link
              </Button>
